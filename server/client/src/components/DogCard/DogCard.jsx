        ...
        <Link to={`/home/${id}`} onClick={() => dispatch(getDogDetail(id))}>
            <div className="Cardy" >
                <div className="CardyDetails">
                    <img className="dog-img" src={image} alt="dog-img" height="200px" width= "300px"/>
                    <h2 className="dog-name" >{name}</h2>
                    <h5 className="dogDetails" key={id}>{`${minWeight}Kg - ${maxWeight}Kg`}</h5>
                    <h4 className="dogDetails">
                        {was_created
